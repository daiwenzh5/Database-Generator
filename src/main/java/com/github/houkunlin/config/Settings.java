...
public class Settings {
    ...
    private void initFileTypes() {
        fileTypes = Lists.newArrayList(
            FileType.of("entity", "Entity", "com.example.entity", null, null, true),
            FileType.of("dao", "Repository", "com.example.repository", null, null, true),
            FileType.of("service", "Service", "com.example.service", null, null, true),
            FileType.of("serviceImpl", "ServiceImpl", "com.example.service.impl", null, null, true),
            FileType.of("controller", "Controller", "com.example.controller", null, null, true)
        );
    }
}
